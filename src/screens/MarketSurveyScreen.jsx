          ...
          <View style={styles.formCard}>
            ...
            <View style={styles.pickerWrapper}>
              <Picker
                ...
                {areaList.map(item => (
                  <Picker.Item key={item.IDArea} label={item.Name} value={item.IDArea} />
                ))}
              </Picker>
            </View>
            ...
            <View style={styles.pickerWrapper}>
              <Picker
                ...
                {customerOptions.map((cust) => (
                  <Picker.Item label={cust.Name} value={cust.IDCustomer} key={cust.IDCustomer} />
                ))}
              </Picker>
            </View>
          ...
          {currentQuestion.type === 'TEXT' ? (
            <View>
              ...
              <TextInput
                ...
                value={
                  currentQuestion.textType === 'LONG-TEXT' ? longAnswer : shortAnswer
                }
                onChangeText={(text) => handleTextAnswerChange(text, currentQuestion)}
...
const styles = StyleSheet.create({
  ...
  optionButton: { borderWidth: 1, borderColor: '#ccc', borderRadius: 8, padding: 10, marginVertical: 5 },
  optionSelected: {
    backgroundColor: '#e6f9e6',
    borderColor: '#4CAF50',
  },
  optionText: { fontSize: 16, padding: 5 },
  button: { backgroundColor: '#33767C', padding: 12, borderRadius: 8, alignItems: 'center', marginTop: 15 },
