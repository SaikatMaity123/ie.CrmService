  ...
  return (
    <SafeAreaView
      ...
      {gamesTab === 1 ? (
        ...
        //             Notice Board
        //           </Text>
        //           {/* <TouchableOpacity onPress={() => navigation.navigate("NoticeBoardList")}> */}
        ...
        //         {/* 🔹 NoticeBoard list inside a 3D Card */}
        //         <FlatList
        //           data={noticeboard}
          ...
          <View style={styles.container}>
            ...
            <View
              style={{
                ...
                backgroundColor: '#ffffff',
                borderRadius: 16,
                padding: 20, // ⬅️ more padding so content can breathe
                shadowColor: '#000',
                shadowOffset: { width: 0, height: 4 },
                shadowOpacity: 0.2,
                shadowRadius: 6,
              ...
              <View
                ...
                <Text style={[styles.chartTitle, { fontSize: 20 }]}>
                  Achievement
                </Text>
                <Dropdown
                  style={[styles.chartDropdown, { minWidth: 120, height: 40 }]}
                  data={dropdownOptions}
                  labelField="label"
                  valueField="value"
                  value={viewType}
                  onFocus={() => fetchSaledata(viewType)}
                  onChange={item => {
                    setViewType(item.value);
                    fetchSaledata(item.value);
                  }}
                />
              </View>
              <View style={styles.chartCard}>
                ...
                <PieChart
                  donut
                  innerRadius={110}
                  radius={140} // ⬅️ make chart bigger
                  data={pieData}
                ...
                <View
                  ...
                  <View style={styles.chartLegendItem}>
                    <View
                      style={[styles.chartDot, { backgroundColor: '#58D68D' }]}
                    />
                    <Text style={styles.chartLegendText}>Sales Value</Text>
                  </View>
                  <View style={styles.chartLegendItem}>
                    <View
                      style={[styles.chartDot, { backgroundColor: '#2E86DE' }]}
                    />
                    <Text style={styles.chartLegendText}>Target Value</Text>
                  </View>
                </View>
              </View>
            </View>
            ...
            <View
              ...
              <View
                ...
                <View
                  ...
                  <Text style={{ fontSize: 16, fontWeight: 'bold' }}>Team</Text>
                </View>
                ...
                <View
                  ...
                  <Text style={{ alignSelf: 'center' }}>
                    ...
                    {Math.ceil(myteam.length / itemsPerPage)}
                  </Text>

                  <TouchableOpacity
                    disabled={(currentPage + 1) * itemsPerPage >= myteam.length}
                    onPress={() => setCurrentPage(currentPage + 1)}
                    style={{
                      padding: 8,
                      backgroundColor:
                        (currentPage + 1) * itemsPerPage >= myteam.length
                          ? '#ccc'
                          : '#3b82f6',
                      borderRadius: 5,
                    }}>
